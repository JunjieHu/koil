...
%             load(strcat(options.load_K,'_',num2str(options.sigma),'.mat'),'K');
        ...
        %% online learning
        %1. KOIL_RSC
        [Model_RSC, AUC_KOIL_RSC(k), Acc_KOIL_RSC(k),err_count, run_time, mistakes, mistakes_idx, SVs, TMs,AUC_list,Acc_list] = nKOIL_RSC( ID_Train, ID_Test, Y, K_KOIL, options);       
